...
void uart_init(u32 bound){
  ...
  GPIO_InitTypeDef GPIO_InitStructure;
	...
	//串口1对应引脚复用映射
	GPIO_PinAFConfig(GPIOA,GPIO_PinSource9,GPIO_AF_USART1); //GPIOA9复用为USART1    PA(9)   TX -->RX
	GPIO_PinAFConfig(GPIOA,GPIO_PinSource10,GPIO_AF_USART1); //GPIOA10复用为USART1  PA(10)  RX -->TX
